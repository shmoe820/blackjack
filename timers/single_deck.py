...
def instruction():
    # Instructions
    instructions = 'This game is called Single Deck Countdown and it will be used in conjunction with Microsoft \n' \
               "Excel file 'single_deck.csv'.  The object of the game is to properly count down a deck as \n" \
               'accurately and as quickly as possible.  As the user, you will start the timer using the \n' \
               "'enter' key when prompted, and hit it again once you have completed the deck.  \n" \
        ...
        while True:
            try:
                ...
                if mistakes == 'q':
                    ...
                    time_integer = round(time_integer, 2)
...
def performance_metrics():
    summary_file_average = 'single_deck_average.csv'
    ...
    for entry in df['No. of Games']:
        ...
        counter += 1
    print('Your P.B average time (min 10 rounds; no mistakes) is ' + str(personal_best) + ' seconds.')
    print('Your P.B standard deviation (min 10 rounds) is ' + str(personal_best_s_d) + ' seconds (' +
